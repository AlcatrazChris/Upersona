...
export function normalizeIndustry(value: unknown): string {
  ...
  if (/政府|事业单位|国企|国有企业|检察院|军队|部队|社区|社会组织|香港政府|退役军人/.test(text)) return '公共管理与事业单位';
  if (/建筑|房地产|装修|装饰|物业/.test(text)) return '建筑与房地产';
  if (/批发|零售|电商|外贸|贸易|销售|商业|酒类|彩票|手机批发|小买卖|商人|做生意|经营者|个体|创业|自营店主|市场管理|区域经理/.test(text)) return '商贸零售与个体经营';
  ...
  if (/物流|交通|仓储|邮政|司机|客运|公路|高速|收费员|外卖|校车/.test(text)) return '交通物流与邮政';
  if (/住宿|餐饮|生活服务|美容|美发|洗护|家政|服务业|服务〗/.test(text)) return '住宿餐饮与生活服务';
  ...
  if (/制造|加工|汽车|汽配|纺织|服装|家具|家电|食品工厂|维修|汽修|机动车检测|弱电工|技术工|工人|飞机维修|建材|五金|试驾车/.test(text)) return '制造与工业服务';
  return '其他';
}
