...
const BRAND_RULES: [string, RegExp][] = [
  ['五菱', /上汽五菱|五菱|五零|五菱宏光|宏光|五菱之光|五菱荣光|五菱星光|五菱缤果|缤果|五菱迷你|五菱mini|mineev|mi'ni|2023星光|^星光$|^迷你$/i],
  ['宝骏', /新宝骏|宝骏|暴君/i],
  ['大众', /一汽大众|上汽大众|大众|高尔夫|帕萨特|帕沙特|迈腾|朗逸|朗行|宝来|桑塔纳|途观|途安|polo|plol|捷达/i],
  ['丰田', /广汽丰田|一汽丰田|丰田|威驰|卡罗拉|凯美瑞|佳美|雷凌|汉兰达|rav4|荣放|致享|锐志|花冠|chr|塞纳|威兰达|霸道/i],
  ['本田', /广汽本田|东风本田|本田|xrv|雅阁|歌诗图|飞度|奥德赛|缤智|思迪|凌派|crv|锋范|峰范/i],
  ['日产', /东风日产|郑州日产|日产|尼桑|逍客|骊威|天籁|蓝鸟|奇骏|轩逸|阳光|途达|风度mx6/i],
  ['现代', /北京现代|现代|瑞纳|途胜|索纳塔|索八|伊兰特|悦动|胜达|朗动|领动|ix35/i],
  ['起亚', /起亚|福瑞迪|奕跑|傲跑|智跑/i],
  ['马自达', /一汽马自达|长安马自达|马自达|昂克赛拉|cx-?5/i],
  ['铃木', /长安铃木|铃木|北斗星|奥拓|利亚纳/i],
  ['斯柯达', /斯柯达|斯科达|明锐|明睿|速派|柯洛克/i],
  ['别克', /别克|君威|gl8|昂科威|昂科拉|英朗|威朗|凯越|世纪/i],
  ['雪佛兰', /雪佛兰|雪弗兰|科鲁兹|科沃兹|迈锐宝|景程|赛欧|科帕奇/i],
  ['福特', /福特|福克斯|福睿斯|蒙迪欧|翼搏|翼虎|嘉年华|致胜/i],
  ['标致', /标致|标志/i], ['雪铁龙', /雪铁龙|世嘉/i],
  ['Jeep', /jeep|吉普|自由侠|自由光|指南者|大指挥官/i],
  ['克莱斯勒', /克莱斯勒|克拉斯勒|漫步者/i], ['菲亚特', /菲亚特|菲翔/i],
  ['三菱', /三菱|欧蓝德/i], ['雷诺', /雷诺/i],
  ['吉利', /吉利|帝豪|英伦|全球鹰|星瑞|博越|远景|几何/i],
  ['领克', /领克/i], ['极氪', /极氪/i],
  ['长安', /长安|欧尚|奔奔|逸动|逸达|悦翔|睿骋|unit|uni-?t|uniz|uni-?z|cs\d|x70a/i],
  ['深蓝', /深蓝/i], ['长城', /长城|哈弗|哈佛|wey|vv\d|欧拉|坦克|长城炮|腾翼/i],
  ['奇瑞', /奇瑞|捷途|开瑞|凯翼|瑞虎|艾瑞泽|风云|icar|冰淇淋/i],
  ['荣威', /上汽荣威|荣威/i], ['名爵', /名爵|锐腾/i], ['大通', /上汽大通|大通|大拿大通/i],
  ['传祺', /广汽传祺|传祺|传奇/i], ['埃安', /广汽埃安|埃安/i],
  ['广汽', /^广汽$/i],
  ['红旗', /红旗/i], ['奔腾', /奔腾|小马/i],
  ['东风', /东风|车风风光|风光580|风神|风行|菱智/i], ['启辰', /启辰/i], ['猛士', /猛士/i],
  ['北汽', /北汽|绅宝|申宝|威旺|威望|幻速/i], ['极狐', /极狐/i],
  ['江淮', /江淮|^瑞风/i], ['比亚迪', /比亚迪|byd|腾势|秦plus|秦pLus/i],
  ['蔚来', /蔚来|乐道/i], ['小鹏', /小鹏/i], ['理想', /理想/i], ['零跑', /零跑/i],
  ['特斯拉', /特斯拉/i], ['极星', /极星/i],
  ['宝马', /宝马|bmw/i], ['MINI', /宝马mini|^mini$/i], ['奔驰', /奔驰|benz/i], ['奥迪', /奥迪|audi/i],
  ['保时捷', /保时捷|macan/i], ['路虎', /路虎|发现运动/i], ['雷克萨斯', /雷克萨斯|雷克沙斯/i],
  ['凯迪拉克', /凯迪拉克/i], ['沃尔沃', /沃尔沃/i], ['林肯', /林肯/i],
  ['众泰', /众泰|大迈/i], ['海马', /海马|福美来|海福星/i], ['力帆', /力帆/i],
  ['东南', /东南|東南|dx3|富利卡/i], ['黄海', /黄海/i], ['野马', /野马/i], ['华颂', /华颂/i],
  ['纳智捷', /纳智捷/i], ['夏利', /夏利/i], ['中华', /华晨中华/i],
];

const NEW_FORCES = new Set(['蔚来', '小鹏', '理想', '零跑', '特斯拉', '极星', '极氪']);
const IMPORTED = new Set(['保时捷', '路虎', '雷克萨斯', 'MINI', '林肯']);
const JOINT = new Set([
  '大众', '丰田', '本田', '日产', '现代', '起亚', '马自达', '铃木', '斯柯达',
  '别克', '雪佛兰', '福特', '标致', '雪铁龙', 'Jeep', '克莱斯勒', '菲亚特',
  '三菱', '雷诺', '宝马', '奔驰', '奥迪', '凯迪拉克', '沃尔沃',
]);

const EV_HINT = /新能源|纯电|电车|ev\b|dmi|dm-?i|双擎|id\.?4|model\s?3|e[126]\b|元plus|秦plus|汉\b|唐\b|宋\b|护卫舰|冰淇淋|几何|埃安|深蓝|启源|银河|极氪|icar|eu5|iev|ei6|猛士917|奔腾小马/i;
